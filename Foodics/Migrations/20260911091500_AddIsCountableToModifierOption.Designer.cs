...
namespace Foodics.Migrations
{
    ...
    [Migration("20260911091500_AddIsCountableToModifierOption")]
    partial class AddIsCountableToModifierOption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foodics.Models.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foodics.Models.EmailOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foodics.Models.HomeSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foodics.Models.PointsSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("EgpPerPoint")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Foodics.Models.SplashScreen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foodics.Models.UserDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foodics.Models.UserLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foodics.Models.WebhookLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foodics.Models.CartItem", b =>
                {
                    b.HasOne("Foodics.Models.Cart", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Foodics.Models.CartItemModifier", b =>
                {
                    b.HasOne("Foodics.Models.CartItem", "CartItem")
                        .WithMany("Modifiers")
            ...
            modelBuilder.Entity("Foodics.Models.Order", b =>
                {
                    b.HasOne("Foodics.Models.Branch", null)
                        .WithMany("Orders")
                        .HasForeignKey("BranchId");

                    b.HasOne("Foodics.Models.POSDevice", null)
                        .WithMany("Orders")
